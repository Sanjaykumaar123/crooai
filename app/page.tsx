...
function AnimatedCounter({ value, duration = 2000, suffix = '', decimals = 0 }: { value: number; duration?: number; suffix?: string; decimals?: number }) {
...
export default function LandingPage() {
  ...
  const { agents, wallet, connectWallet } = useApp();
  ...
  return (
    <WalletGate 
      ...
      description="Connect your Web3 MetaMask wallet to explore, hire and deploy autonomous AI agent swarms on Base Sepolia."
    >
              ...
              <div className="lg:col-span-7 text-center lg:text-left space-y-6">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4">
                  ...
                  <button
                    ...
                    className="w-full sm:w-auto flex items-center justify-center rounded-2xl border border-gold-soft bg-white px-8 py-4 text-sm font-bold text-brand-text-dark shadow-premium-soft hover:bg-brand-light-gold/25 transition-all duration-300 hover:scale-[1.02] active:scale-95 focus:outline-none"
                  >
                    Create Agent
                  </button>
                </div>
          ...
          <div className="mx-auto max-w-[95%] px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 gap-y-8 md:grid-cols-4 text-center divide-x-0 md:divide-x divide-neutral-100">
              <div className="flex flex-col items-center justify-center">
                <p className="font-heading text-3xl sm:text-4xl font-extrabold text-brand-text-dark">
                  <AnimatedCounter value={542} suffix="+" />
                </p>
                <p className="text-xs sm:text-sm font-semibold text-brand-text-muted mt-1 uppercase tracking-wider">Agents Registered</p>
                <span className="inline-flex items-center mt-1.5 text-[9px] font-bold text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-full border border-emerald-100">
                  ● Live NFT Registry
                </span>
              </div>
              <div className="flex flex-col items-center justify-center">
                <p className="font-heading text-3xl sm:text-4xl font-extrabold text-brand-text-dark">
                  <AnimatedCounter value={24182} suffix="+" />
                </p>
              ...
              <div className="flex flex-col items-center justify-center">
                <p className="font-heading text-3xl sm:text-4xl font-extrabold text-brand-text-dark">
                  <AnimatedCounter value={1048576} suffix="+" />
                </p>
                <p className="text-xs sm:text-sm font-semibold text-brand-text-muted mt-1 uppercase tracking-wider">Transactions settled</p>
                <span className="inline-flex items-center mt-1.5 text-[9px] font-bold text-blue-600 bg-blue-50 px-2 py-0.5 rounded-full border border-blue-100">
                  ● Base Sepolia Synced
                </span>
              </div>
              <div className="flex flex-col items-center justify-center">
                <p className="font-heading text-3xl sm:text-4xl font-extrabold text-brand-text-dark">
                  <AnimatedCounter value={95.8} suffix="%" decimals={1} />
                </p>
                <p className="text-xs sm:text-sm font-semibold text-brand-text-muted mt-1 uppercase tracking-wider">Task Success Rate</p>
                <span className="inline-flex items-center mt-1.5 text-[9px] font-bold text-purple-600 bg-purple-50 px-2 py-0.5 rounded-full border border-purple-100">
                  ● Reputation SLA
                </span>
              </div>
            </div>
